...
func setup_waves():
	waves = [
		...
		{# red/blue//pruple
			...
			"max_enemies": 25,
			"enemies": [
				{ "type": EnemyType.SQUARE, "red": 10, "yellow": 0, "blue": 0, "speed": 100, "chance": 0.4},
				{"type": EnemyType.SQUARE,  "red": 0,  "yellow": 0, "blue": 10, "speed": 50, "chance": 0.4 },
				{"type": EnemyType.SQUARE,  "red": 10,  "yellow": 0, "blue": 10, "speed": 75, "chance": 0.2 }
			]
		},
		{#primary -3
			"spawn_rate": 0.2,
